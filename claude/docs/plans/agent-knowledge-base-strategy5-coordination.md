...
| U6 (fix Pass 4's delayed-collision-delete gap — gate the manifest write, not just the delete) | `cobb` | `ae77ce414732a6168` | in-flight | — | `analyst` → — (Pass 5 to follow, same review file) | — |
