...
| U4 (correct ml.md's Stage 8 Phase 2 addendum per U3's falsification) | `data-scientist` | `a1dbec04fe6cac54d` | in-flight | — | n/a — same delegate resumed via SendMessage | — |
