...
| U4b (fix U4a's blocker: add the 2 MCP tools to 4 agents' `tools:` allowlists) | `cobb` | `a04f6f292c8ee11a0` | in-flight | — | n/a — teco to close with a live tool-visibility probe per the review's own suggested method | — |
