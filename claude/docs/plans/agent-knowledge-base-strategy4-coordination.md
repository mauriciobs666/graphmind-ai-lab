...
| U7 (Stage 9 distillation-ingestion hook) | `cobb` | `acd2a171f0554221c` | in-flight | — | `analyst` → — | — |
| U8 (floor-instability methodology consult, escalated by U6b/U6c) | `data-scientist` | `a83b0581dd06762dc` | in-flight | — | n/a — advisory note, not implementation | — |
