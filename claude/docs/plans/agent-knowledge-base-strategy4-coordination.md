...
| U6b (fix U6a's blocker + 2 majors: re-verify R6's score, correct DEF-1's X1 citation, run a pooled crowding-out coverage probe) | `qa-engineer` | — | queued | — | n/a — same delegate resumed | — |
