...
| U7a (Stage 9 review — diff-scoped) | `analyst` | `a80309ea9d6da6b52` | in-flight | — | n/a | — |
...
| U9 (apply U8's 2 "actionable now" items: SKILL.md floor-risk reframe + tight-clustering-gap flag as standing practice) | `data-scientist` | `a83b0581dd06762dc` | in-flight | — | n/a — same delegate resumed via SendMessage | — |
