...
## Five platform failures, all cleanly recovered

Five units were killed mid-run by session rate limits (HTTP 429) — U10, U15,
U19, U20 and U41 — and **not one lost a disposition.** They landed at five
different points, which is what makes them useful together:
...
Three rules come out of it, and all three are now load-bearing for this pass:
