...
- **What:** Frontmatter `description` compressed 833 → 724 chars (-13%): tightened phrasing, dropped restated detail, kept every routing/boundary clause. `claude/scripts/audit-team.sh` boundary-pair symmetry (joern↔graph-dba) re-verified green. No body/catalog change.
