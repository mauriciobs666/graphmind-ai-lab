...
- **Notes:** Paired with architect K-002. **Update 2026-07-08:** the handoff transport is now fixed — the coder receives the architect's plan as a document path (`<component>/docs/plans/<slug>.md`) and reads the file itself; the live validation run remains.
