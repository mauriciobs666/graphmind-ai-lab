# AGENTS.md — Severino project

Brief for any AI agent working in this folder (OpenCode reads this `AGENTS.md`; a sibling
`CLAUDE.md` imports it so Claude Code reads it too). Read first.
