...
| U131 | `tdd-engineer` | — | queued | Step 1 — `guard-judge-understanding`, offline half (`modelbench/scoring/classification.py`, pack data, `refresh_golden.py`'s new origin) | `analyst` (deferred to full-S4 code gate) → — | — |
