...
| U37 — Plan v1.15: close P8-1/P8-2/P8-3, re-pair to note v1.18, sweep **all seven** tables against rule 5(b) | `architect` (fresh) | `a522a1704449cdc2e` | in-flight | `docs/plans/small-model-benchmarking.md` v1.15 | `analyst` re-check → — | — |
