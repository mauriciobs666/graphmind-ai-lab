...
| U38 — Narrow re-check of v1.15's delta (Pass 9). Sharpest question: Table G's residuals have an **intermediate state, not a commit**, as their baseline | `analyst` (**fresh** — Pass 8's instance is at 282k tok *and* proposed the exemption the note overruled) | `a32855305cbdf4b2c` | in-flight | `docs/reviews/small-model-benchmarking.md` `## Pass 9 (narrow)` | self → — | — |
