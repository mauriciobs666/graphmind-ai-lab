...
| U133c | `data-scientist` | `a298b7b1368ba79c6` | in-flight | Apply review A4: correct `-ml` §7.2's `nlq-generator` row (n_eff=34, floor 17.6pp, MDD80 22.3pp) and §3's fact table (34 answerable / 6 unanswerable split), in place, per the doc's own same-kind/role revision convention | — | — → — | — |
