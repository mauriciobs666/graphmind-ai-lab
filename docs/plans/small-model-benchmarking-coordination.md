...
| U36 — P8-1: how is a family-corrected quantile level `α/(2k)` represented exactly? (`permille: int` cannot express it; non-exact at k=3 in any decimal unit) | `data-scientist` (fresh) | `a1aaf4909260e0e14` | in-flight | `docs/plans/small-model-benchmarking-ml.md` v1.18 | `analyst` re-check → — | — |
