...
| U35 — Narrow re-check of v1.14's delta only (**not** a full Pass 8), per Pass 7's own recommendation | `analyst` (**resumed**, Pass 7's own instance) | `a7144f0028209bdc0` | in-flight | `docs/reviews/small-model-benchmarking.md` `## Pass 8 (narrow)` | self → — | — |
