...
> **Status:** active · **Owner:** `architect` · **Tracks:** — (M<n> TBD) · **Version:** 1.25 · **Reviews:** `docs/reviews/salesperson-ui.md`, `docs/reviews/salesperson-ui-impl.md`
...
- **The re-shaped `ServiceError` family is filtered by a *measured* route set, not by a route class.**
  ...
  **The same standard governs the *inherited* handlers, and that is where it bites next.** The
  ...
  it is **measured, and re-measured at S9**, which is why S8c pins the `services.` access set as an
  assertion that S9 is expected to redden rather than as prose. S9's row owns the re-derivation.
