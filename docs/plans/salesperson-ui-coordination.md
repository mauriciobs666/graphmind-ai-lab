...
| **S8 gate** — Pass 10: does the gate *fail*? + the S8/S10 boundary + six plan rulings | `analyst` (**fresh, clean budget** — this review is a 1090-line module and a 1900-line test file) | `a22e72491d00563b4` | in-flight (**holds the live DB**) | `docs/reviews/salesperson-ui-impl.md` `## Pass 10` | — | — |
