...
| **S7c gate** — Pass 9 over **four** commits: S7b2, S7c, S7c2, S7c3 | `analyst` | `a893ac5083e24f334` (resumed — wrote Pass 8 on this same file) | in-flight (**holds the live DB**; `reference` is seeded and must be left so) | `docs/reviews/salesperson-ui-impl.md` `## Pass 9` | — | — |
