...
| **v1.22** — P11-5 (§5.2's messages row owes §5.3's `503`, + the `401` license) and **S9's row gains the two obligations Pass 11 created** | `architect` | `ad81e9cdb12dfbb28` (resumed — wrote v1.21, 146k tok) | in-flight | `docs/plans/salesperson-ui.md` v1.22 | teco-verified (step-row hashes) → — | — |
