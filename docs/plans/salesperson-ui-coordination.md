...
| **S8b gate** — Pass 11: is P10-1 closed? is `SERVICE_ERROR_ROUTES` a measurement? + S8b's three counter-claims against Pass 10 | `analyst` (**fresh, not Pass 10's author**) | `a6adcb0f5a590acce` | in-flight (**holds the live DB**) | `docs/reviews/salesperson-ui-impl.md` `## Pass 11` | — | — |
