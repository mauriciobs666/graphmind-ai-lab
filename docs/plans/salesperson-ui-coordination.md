...
| **U30** — Plan v1.20: Pass 10's **three plan defects** + a ruling on whether `DemoNotSeededError` needs a table row | `architect` (**fresh**) | `a02d1c13201470da7` | in-flight (file-disjoint from S8b) | `docs/plans/salesperson-ui.md` **v1.20** | **none — plan gates stopped** | — |
