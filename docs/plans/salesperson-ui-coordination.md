...
## RESUME HERE — state as of 2026-09-11, S9c closed, S9d ready to dispatch
...
| **S9d** — remove the per-participant record cache whole | `coder` | — | queued — **unblocked, S9c closed** | `storefront.py`, tests | `analyst` | — |
