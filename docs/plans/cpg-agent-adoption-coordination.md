...
| U8 | `analyst` | `adb2e44fe3ceff7ee` | in-flight | Diff-scoped code gate on U7's six-file wording fix — appends `## Pass 3 — U7 fix-round diff gate` to `docs/reviews/cpg-agent-adoption.md`. | — |
