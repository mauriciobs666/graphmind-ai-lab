...
| U6 (close) | `qa-engineer` or `data-scientist` | — | queued | Combined live regression pass over both K-057 (`v5`) + K-058 (write guard) together, per coordination sequencing | self → — | — |
