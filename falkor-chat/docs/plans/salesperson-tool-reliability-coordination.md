...
| U3 (Track A follow-up) | `coder` | `a6bc71a78fc5750b3` | in-flight | K-057 fix, resumed: iterate wording once more on the category-omission synthesis defect, re-run n=20 | `analyst` → pending (U5) | — |
