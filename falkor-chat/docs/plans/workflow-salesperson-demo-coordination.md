...
| U29f-2 | `tdd-engineer` (resume U29f) | `a1a0c4b3b0c42fecf` | in-flight | implement the `WITH DISTINCT <tuple>` fix (U29f-1's confirmed shape), replacing the reject-guard; update/add tests incl. live golden-set regressions for `nlq-16/17/20/25/26` | `analyst` (U29f-gate) → — | — |
