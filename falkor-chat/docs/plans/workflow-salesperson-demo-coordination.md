...
| U31-fix | `tdd-engineer` (resume U29f) | `a1a0c4b3b0c42fecf` | queued | fix both MAJORs (2+ column tuple-distinct test gap; duplicate-`returns` uniqueness check) + 2 MINORs | `analyst` (re-gate) → — | — |
