...
| U29-gate | `analyst` (resume) | — | queued | corpus content review (topical/`Entity.type`/relationship-predicate variety, the required conflicting-fact pair + absent-fact case actually present and clean, no answer-key leakage risk) | self → — | — |
