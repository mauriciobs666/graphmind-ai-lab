...
| U33-regate | `security-expert` (resume `a6ebccba4219bf9db`) | `a6ebccba4219bf9db` | in-flight | confirmation pass on the op-allowlist fix → `docs/reviews/workflow-nl-query-generation-security.md` new dated section | self → — | — |
