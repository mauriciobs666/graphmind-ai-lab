...
| U32 | `data-scientist` (resume `ac9e47f85f5801d9a`, the RCA author) | `ac9e47f85f5801d9a` | in-flight | methodology read: does 33/39 (100% ex. the 2 structurally-excluded shapes) satisfy FR-4/AC-4/AC-2, or does the gate formula/DSL scope need revisiting? | self → — | — |
