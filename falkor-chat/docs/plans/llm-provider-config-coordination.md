...
|---|---|---|---|---|---|
| U0 | `tico` | `ae8daf5e6fb321743` | in-flight | requirements `Status:` → `Ready for design` | none (mechanical) |
| U1 | `architect` | `a6607eea81e284553` | in-flight | `docs/plans/llm-provider-config.md` + K-042/M4 backlog entry | `analyst` → — |
| U2 | `graph-dba` | `a9469ba9c6b47c56b` | in-flight | `docs/plans/llm-provider-config-graph.md` | `analyst` (with U1) → — |
| U3 | `analyst` | — | queued | `docs/reviews/llm-provider-config.md` | — |
