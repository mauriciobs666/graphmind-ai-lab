...
`docs/requirements/workflow-durable-profile.md`. Each is independently motivated and
independently shippable — read this one for cart/order-shaped mutable state specifically.
