...
> Source: design conversation with the stakeholder, 2026-07-22. Backlog companion: **K-032** (`docs/BACKLOG.md`). This doc is the WHAT/WHY; K-032 carries the framing sketch and pointers to owners.
