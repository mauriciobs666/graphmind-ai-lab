...
```bash
cd server && .venv/bin/python -m pytest -q      # 70 passed
```
...
`read_messages`, `create_thread`, `create_channel`, `search_messages` (see [DESIGN.md §15](docs/DESIGN.md#15-mcp-transport-k-002--the-agent-front-door)).
